...
### Обязательные:
- [x] Сохранение текстовых сообщений и ссылок
- [x] Кликабельные ссылки (http:// или https://)
- [x] Сохранение изображений, видео и аудио (Drag & Drop и иконка загрузки)
- [x] Скачивание файлов на компьютер
- [x] Ленивая подгрузка (по 10 сообщений при скролле)
